...
from test_keepassx_043 import TestKeePassX043  # noqa: E402


class TestKeePassXImport(TestKeePassX043):
    def setUp(self):
        self.tempdir = tempfile.mkdtemp()
        self.imported_db = os.path.join(self.tempdir, 'imported.psafe3')
        subprocess.call(['bin/pasaffe-import-keepassx', '-q',
                         '-f', './tests/databases/keepassx-043.xml',
                         '-d', self.imported_db,
                         '-y', '-m', 'pasaffe'])
